...
class QuadraticSolver:
    ...
    def show_help_menu(self):
        ...
        print("  --next      will let you to the next page.")
    ...
    def learn_quadratic_equations(self):
        ...
        z3 = symbols('aα^2')
        z4 = symbols('bα')
        print("• Quadratic equation : A quadratic equation in the variable x is of the form")
        eq2 = Eq(z + z1 + z2, 0)
        pprint(eq2)
        print('where a, b, c are real numbers and a ≠ 0.')
        print("• Roots of a quadratic equation : A real number α is said to be a root of the quadratic equation")  
        eq3 = Eq(z + z1 + z2, 0)
        pprint(eq3) 
        print('if')
        eq11 = Eq(z3 + z4 + z2, 0)
        ...
        eq4 = Eq(z + z1 + z2, 0)
        pprint(eq4) 
        print("are the same as the zeroes of the quadratic polynomial") 
        eq5 = Eq(z + z1 + z2, 0)
        pprint(eq5)
        ...
        if command == "next":
            ...
            print("• Existence of roots of a quadratic equation: A quadratic equation") 
            eq6 = Eq(z + z1 + z2, 0)
            pprint(eq6) 
            ...
            print("has: ")
            print("         (i) two distinct real roots if  ")
            eq7 = Gt(a - a1, 0) 
            pprint(eq7) 
            print("         (ii) two equal real roots if  ")
            eq8 = Eq(a - a1, 0) 
            pprint(eq8)  
            print("         (iii) no real roots if ") 
            eq9 = Lt(a - a1, 0) 
            pprint(eq9)
        else:
            print("Please type 'next' only!") 
        ...
        if command == "next":
            ...
            eq13 = z + z1 + z2
            pprint(eq13) 
            print("we try to find two numbers whose sum is b and whose product is ac. We now apply this idea to solving quadratic equations.")
            y = symbols('2x^2')
            y1 = symbols('5x')
            y2 = symbols('3')
            y3 = symbols('2x')
        ...
        if command == "next":  
            ...
            print("Any quadratic equation of the form")  
            eq12 = Eq(z + z1 + z2, 0)
            pprint(eq12)
            print("where a ≠ 0 can be solved for both real and imaginary solutions using the quadratic formula:") 
    ...
    def solve_quadratic_equation(self):
        ...
        #call middle term function from factor.py file 
        factor.middle_term(a, b, c) 
